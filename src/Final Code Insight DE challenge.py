...
with open('products_test.csv', newline = '', encoding = 'utf8', errors = 'ignore') as csvfile:
...
result = {}
with open('order_products__test.csv', newline = '', encoding = 'utf8', errors = 'ignore') as csvfile:
...
os.chdir('../output')
with open('report__test.csv', 'w', newline = '') as csvFile:
